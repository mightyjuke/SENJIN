...
// Run carry (SENJIN tuning): upright forward lean; the right hand holds the shaft at the hip, butt end up ahead-left past the
...
export const LOCO_CLIPS = {
  ...
  // descent after an air string (SENJIN tuning A→X×n: a ≈0.4 s spread-arm fall): torso back, arms flung wide, spear held out
